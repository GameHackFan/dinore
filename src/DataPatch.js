const dataPatch = 
{
  ...
  data:
  {
    // Morgan Wake Up Gun Blow Strikebox Improvement
    // Strikebox ID From 6A to 7E
    // New strikebox covers a better range and also inside.
    "463308": ["7E", "00"],



    // Butcher punch strikebox position X improvement
    // From FFA3 to FF9E
    // Moved forward 5 pixels.
    "1064600": ["9E", "FF"],

    // Butcher slap strikebox width improvement
    // From 35 to 4A
    // Increased 21 pixels
    "1064602": ["4A", "00"],
    ...
    // Morgue slap strikebox position X improvement
    // From FF95 to FF90
    // Moved forward 5 pixels.
    "1065308": ["90", "FF"],

    // Morgue slap strikebox width improvement
    // From 55 to 6C
    // Increased 23 pixels
    "1065310": ["6C", "00"],
    ...
    // Tyrog Slap Strikebox Position X Improvement
    // From FF86 to FF7E
    // Moved forward 8 pixels.
    "1065656": ["7E", "FF"],

    // Tyrog Slap Strikebox Width Improvement
    // From 5F to 7F
    // Increased 32 pixels
    "1065658": ["7F", "00"],
    ...
    [
      ...
      "21", "06", "00", "05", "00", "08", "00", "0B",
      "40", "0F", "80", "0F", "EE", "0F", "BB", "0C",
      "77", "08", "44", "05", "FF", "0F", "A9", "00"
    ],
    ...
    // Slice / Slisaur Boomerang Pallete Fix
    "940736": ["16", "01"],
    "940740": ["16", "01"],
    "940768": ["16", "01"],
    "940772": ["16", "01"],
    ...
    [
      ...
      "10", "0C", "32", "0E", "EF", "0E", "CD", "0C",
      "89", "08", "45", "04", "FF", "0F", "A9", "00"
    ],
    ...
    [
      ...
      "A1", "0D", "D3", "0F", "EF", "0C", "CE", "09",
      "8B", "05", "59", "02", "FF", "0F", "A9", "00"
    ],
    ...
    [
      ...
      "5C", "04", "7F", "06", "EF", "0F", "BD", "0E",
      "7A", "0B", "37", "08", "FF", "0F", "A9", "00"
    ],
    ...
    [
      ...
      "4B", "06", "6E", "08", "EF", "0F", "BD", "0F",
      "68", "0E", "12", "0B", "FF", "0F", "A9", "00"
    ],

    // Hannah Pallete 6 (Green and Purple)
    "1704608":
    [
      "11", "01", "CB", "0F", "A8", "0E", "75", "0B",
      "43", "08", "10", "00", "30", "00", "52", "00",
      "74", "02", "A7", "04", "EF", "0E", "BF", "0D",
      "7C", "0A", "3A", "07", "FF", "0F", "A9", "00"
    ],
    ...
    [
      ...
      "68", "0D", "9B", "0F", "FD", "0E", "EA", "0A",
      "B8", "06", "75", "02", "FF", "0F", "A9", "00"
    ],
